...
export default function ProductPage() {
  ...
  const images = extraImages[product.slug] ?? [product.images[0], product.images[0], product.images[0]];
        ...
        <div className="grid grid-cols-1 gap-12 py-20 lg:grid-cols-[55%_1fr] lg:gap-20">
          ...
          >
            ...
            <div className="mt-8 flex flex-col gap-3">
              {ingredients[product.slug] && (
                <AccordionSection
                  title="Состав"
                  content={ingredients[product.slug]}
                />
              )}
              {usage[product.slug] && (
                <AccordionSection
                  title="Применение"
                  content={usage[product.slug]}
                />
              )}
            </div>
          </motion.div>
